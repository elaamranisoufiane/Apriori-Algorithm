...
#  Objet : ALgorithm d'Apriori avec langage Java                                   #        
####################################################################################
*/
 ...
 public void aprioriProcess()
    {
        ...
        //get config
        getConfig();
        System.out.println("L'algorithme Apriori a commencé !! .\n");
        //le temps de debut
        d = new Date();
        start = d.getTime();
        ...
        System.out.println("Temps d'execution est : "+((double)(end-start)) + " ms.");
    }
 //!!!!!!!!!!!!!!!!!!!!!!!
